...
ActiveRecord::Schema.define(version: 20170825091907) do
  ...
  create_table "requests", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.integer  "semester"
    t.index ["college_id"], name: "index_requests_on_college_id", using: :btree
    t.index ["email"], name: "index_requests_on_email", using: :btree
  ...
  create_table "statuses", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at",                                       null: false
    t.datetime "updated_at",                                       null: false
    t.index ["request_id"], name: "index_statuses_on_request_id", using: :btree
  end
  ...
  create_table "users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.string   "gender"
    t.string   "userpic"
    t.index ["campus"], name: "index_users_on_campus", using: :btree
  ...
  add_foreign_key "requests", "colleges"
