...
def payment
 ...
 #time = Time.now+3.days
    ...
    @payment_request = client.payment_request({amount: amount, purpose: reason, send_email: true,phone:phone,buyer_name:fullname, email:email, redirect_url: 'http://recoverker.com/thankyou'})
